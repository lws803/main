...
===== Search guessing
This feature will also display actual *Keywords matched* and *Keywords guessed* to give you a good indicator of which words are guessed.
...
NOTE: If the keywords entered bears no similarity with any keywords among the contacts in your address book, it will list all your contacts. This applies especially for text type parameters such as *name*, *addresses*, *tags*, *notes* and *position*
