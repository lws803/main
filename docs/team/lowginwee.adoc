...
* *Minor enhancement*: The *add command* automatically parsers the contact's name to capitalize the first letter and remove additional spaces. This is to standardize contacts in the address book
