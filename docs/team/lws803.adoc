...
== Overview
CorpPro is an addressbook targeted for corporate users. + 
It is the *RIGHT* way to manage your contacts. +
CorpPro is powered by Java and provides an intuitive interface with high speed usage using a command line interface.
